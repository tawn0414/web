...
<body>
   ...
   <div>
		...
		<div style="width: 210px; margin-left: auto; margin-right: auto;">
			<input type="button" value="작성 완료" onclick="alert('작성을 완료했습니다.'); location.href='ask.jsp'" style="color:white; background-color: #fc6c3f; width: 100px"/>
			<input type="button" value="작성 취소" onclick="alert('작성을 취소했습니다.'); location.href='ask.jsp'" style="color:white; background-color: #fc6c3f; width: 100px"/>
		</div>
	</div>
	<p></p>
